...
const headCells = [
  ...
  { id: "usertype", numeric: false, disablePadding: false, label: "Transaction ID" },
  { id: "canID", numeric: false, disablePadding: false, label: "User Details" },
  { id: "email", numeric: false, disablePadding: false, label: "Time" },
  { id: "number", numeric: true, disablePadding: false, label: "Transaction Details" },
  {
    id: "dateOfJoining",
    numeric: false,
  ...
  const getUserData = async () => {
    ...
    try {
      const response = await axios.get(
        `${adminbaseurl}/user/get-users-list-by-admin`,
        info
      );
