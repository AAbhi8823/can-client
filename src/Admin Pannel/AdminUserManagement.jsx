        ...
        <>
          <div className="p-[15px] flex justify-between">
            <div className="flex">
              ...
              <div
                className="mr-3 border-5 bg-[#fff] p-[10px]"
                style={{
                  borderRadius: "50px",
                  boxShadow: " 0px 5px 30px 0px #0000000D",
                }}
            ...
            <div className="flex">
              <div>
                <input
                  className="p-[10px] mr-[10px] "
                  style={{ width: "280px", borderRadius: "30px" }}
                  placeholder="Search"
                  type="text"
                />
              </div>
