  ...
  return (
        ...
        <>
            <TabPanel value={value} index={1}>
                <div className=' lg:p-7 p-4 mt-10 shrink-0 w-[100%]  bg-[#C31A7F]  bg-white rounded-[30px] border-[1px]' style={{
                    boxShadow: '0px 10px 60px 0px rgba(0, 0, 0, 0.10)'
                }} >
          {/* background */}
          <div className="bg-[#FEF8FD] h-full mt-10">
          {/* top bar */}
          <div className="pl-[10%] pr-[6%] flex justify-between pt-8 flex-wrap">
          ...
          {selectedOption === "Today" && (
            <>
              <div className="pl-[10%] pr-[6%]  ">
                <div className="bg-white shadow-xl mt-8 flex flex-wrap justify-between px-20 rounded-2xl py-2">
