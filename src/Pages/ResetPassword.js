      ...
      <NavLink to="/">
        <div className="lg:ml-[80px] mt-2 lg:absolute flex items-center justify-center ">
          ...
          <img
            src={CANa}
            alt="not found"
            className="w-[42.88px] can-21 h-[16.19px]  "
          />
        </div>
      </NavLink>
      <div className="lg:h-screen h-fit md:flex sm:block lg:p-0 px-4 pt-[50px]  items-center  justify-center">
        <div
          className="shadow-xl px-[70px] py-11  bg-[#D0F5D3] bg-opacity-10 z-10 reset_content backdrop-blur-lg rounded-[20px]"
          style={{
        ...
        >
          <div className=" flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              <p className="lg:text-[14px]  text-[#555555] text-[12px] font-semibold">
            ...
            <div className="mt-2">
              <p className="  text-[#C31A7F] font-semibold cursor-pointer underline decoration-1">
                Login
              </p>
            </div>
          </div>
