          ...
          {/* <div className="hidden md:block lg:block w-[50%]   flex flex-col items-center justify-center ">
             <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col items-center justify-center mt-3">
                <h1 className="text-center text-[36px] lg:text-[2.67vw]  font-semibold">
                  You are not alone
                </h1>
                <p className="text-center text-[18px] lg:text-[1.2vw] font-medium mt-2">
                  Join and host meeting to share relate and listen to
                  experiences.
                </p>

                <p className="text-center text-[18px] lg:text-[1.2vw]   font-medium">
                  Add people you connect with to your support group to
                </p>
                <p className="text-center text-[18px] lg:text-[1.2vw]   font-medium">
                  chat, call, and spend time with.
                </p>
              </div>
                      ...
                      <div
                        ...
                        className={`flex ${
                          select !== null && select !== cata._id
                            ? "opacity-50"
                            : ""
                        } ${loading ? "w-[90%] " : "" } justify-center cursor-pointer`}
                      >
                        {loading ? (
