...
const WhyCan = () => {
  ...
  return (
    <>
      ...
      <div>
        {/* <div class="flex -space-x-1 overflow-hidden mx-auto">
  <img class="inline-block h-6 w-6 rounded-full ring-2 img2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
  <img class="inline-block h-6 w-6 rounded-full ring-2 img2 ring-white" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
</div> */}
      </div>
