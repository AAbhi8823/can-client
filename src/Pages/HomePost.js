                        ...
                        <div className=' lg:flex'>
                            ...
                            <div className='bg-[#FEF8FD] lg:px-0 px-2 w-[100%] lg:flex-row lg:flex'>
                                ...
                                <div className='flex flex-col lg:px-16 '>
                                    ...
                                    <div className=' lg:p-7 p-4 mt-1 shrink-0  bg-[#C31A7F]  bg-white rounded-[30px] border-[1px] rounded-xl  ' style={{
                                        ...
                                        <div className=' flex items-center gap-2' >
                                            ...
                                            <div className='flex  w-full items-center justify-between' >
                                                ...
                                                <div className='flex  items-center justify-between relative  pb-6' >
                                                    ...
                                                    {threeDots && (<div className=' w-max h-max bg-white  shadow-2xl absolute top-0 right-7 text-center pt-2 pb-2' ref={threeDotsOutClick}>
                                                        <p className='p-2 px-4 cursor-pointer hover:bg-[#C31A7F] hover:text-[#fff] ' onClick={toggleBlockTab} >Block Sierra</p>
                                                                ...
                                                                <div className='lg:w-[40%] flex flex-col justify-between gap-4 p-4 relative'>
                                                                    ...
                                                                    <div className=' bottom-4'>
                                                                        <div className='flex gap-3 w-full bg-transparent'>
                                                                            ...
                                                                            <input placeholder='Write here...' onChange={(e)=>takeValue} className='outline-none w-full bg-transparent ' />
                                                                        </div>
                                                                        <div className='flex justify-between mt-2'>
                                                                            ...
                                                                            <div onClick={handleCom} className='bg-[#C31A7F] text-white cursor-pointer  px-10 px-6 rounded-xl'>Post</div>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div className=' lg:p-7 p-4 mt-5 shrink-0  bg-[#C31A7F]  bg-white rounded-[30px] border-[1px] rounded-xl  ' style={{
                                        boxShadow: '0px 10px 60px 0px rgba(0, 0, 0, 0.10)'
                                    }} >
                                        {/* inner container */}
                                        <div className=' flex items-center gap-2' >
